...
Public Class AD110
    ...
    Dim acRepo As New AdminCodeRepository
    Dim tbill As CustodianAdmin.Model.TelephoneBill
...
checkIfPrint:
    ...
    Private Sub grdData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdData.RowDataBound
        ...
        If (ea.Row.RowType = DataControlRowType.DataRow) Then
            Dim drv As CustodianAdmin.Model.TelephoneBill = CType(ea.Row.DataItem, CustodianAdmin.Model.TelephoneBill)
